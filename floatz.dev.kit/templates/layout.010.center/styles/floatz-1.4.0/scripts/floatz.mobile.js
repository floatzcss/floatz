...
window.floatz.mobile=(function(floatz,$){"use strict";var self={module:{name:"floatz.mobile",version:"1.4.0",start:start,bind:bind},bind:bind};var module=self.module;function start(){if(!$){floatz.log(floatz.LOGLEVEL.ERROR,"Module "+module.name+" depends on jquery.js which is not loaded",module.name);return;}
