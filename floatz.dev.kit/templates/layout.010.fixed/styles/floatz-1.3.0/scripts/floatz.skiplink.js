...
window.floatz.skiplink=(function($){"use strict";var self={module:{name:"floatz.skiplink",version:"1.2.0",start:start}};var floatz=window.floatz;var module=self.module;function start(){fixSkipLinks();fixSkipLinkAnchors();floatz.log(floatz.LOGLEVEL.INFO,"Module "+module.name+" started",module.name);}
...
floatz.loadedModules.push(module);floatz.log(floatz.LOGLEVEL.INFO,"Module "+module.name+" loaded",module.name);return self;}(jQuery));