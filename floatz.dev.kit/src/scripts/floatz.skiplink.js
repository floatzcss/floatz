...
window.floatz.skiplink = (function () {
    ...
    function fixSkipLinks() {
        if (!floatz.userAgent.isMobile() &&
            (floatz.userAgent.isEngine(floatz.ENGINE.WEBKIT) || floatz.userAgent.isBrowser(floatz.PLATFORM.OPERA))) {
    ...
    function fixSkipLinkAnchors() {
        if (!floatz.userAgent.isMobile() &&
            (floatz.userAgent.isEngine(floatz.ENGINE.WEBKIT) || floatz.userAgent.isBrowser(floatz.PLATFORM.OPERA) ||
                floatz.userAgent.isBrowser(floatz.PLATFORM.MSIE))) {
