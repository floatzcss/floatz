...
###Boxes
The basic layout class is a *box*. Each *box* floats left (this is where the name *floatz* comes from) and gets a default width of 100% of its surrounding element.
```
<div class="flz_box">
   ...
</div>
